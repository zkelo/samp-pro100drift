...
public OnPlayerCommandText(playerid, cmdtext[])
{
	...
	{
		SendClientMessage(playerid,COLOR_INTERFACE,"Справка по анимациям: /animhelp");
		SendClientMessage(playerid,COLOR_INTERFACE,"Справка по специальным действиям: /spachelp");
 		return 1;
	}
	if(!strcmp(cmd,"/animhelp",true))
	{
		SendClientMessage(playerid,COLOR_INTERFACE,"Команды управления анимациями:");
        SendClientMessage(playerid,COLOR_INTERFACE,"Синтаксис: /anim [animid].");
        SendClientMessage(playerid,COLOR_INTERFACE,"Списки анимаций: /animlist [1 - 2]");
		SendClientMessage(playerid,COLOR_INTERFACE,"Остановить анимацию: /stopanim");
		return 1;
	}
	...
	{
		if(!strlen(tmp)||strval(tmp)<1||strval(tmp)>3) return SendClientMessage(playerid,COLOR_INTERFACE,"{3494FF}Сервер: {FFFFFF}Используйте: /animat [1 - 3]");
		switch(strval(tmp))
		{
	...
	{
		if(!strlen(tmp)||strval(tmp)<1||strval(tmp)>12) return SendClientMessage(playerid,COLOR_INTERFACE,"{3494FF}Сервер: {FFFFFF}Используйте: /animbar [1 - 12]");
		switch(strval(tmp))
		{
	...
	{
		if(!strlen(tmp)||strval(tmp)<1||strval(tmp)>11) return SendClientMessage(playerid,COLOR_INTERFACE,"{3494FF}Сервер: {FFFFFF}Используйте: /animbaseball [1 - 11]");
		switch(strval(tmp))
		{
	...
	{
		if(!strlen(tmp)||strval(tmp)<1||strval(tmp)>13) return SendClientMessage(playerid,COLOR_INTERFACE,"{3494FF}Сервер: {FFFFFF}Используйте: /animfire [1 - 13]");
		switch(strval(tmp))
		{
	...
	{
		if(!strlen(tmp)||strval(tmp)<1||strval(tmp)>5) return SendClientMessage(playerid,COLOR_INTERFACE,"{3494FF}Сервер: {FFFFFF}Используйте: /animbeach [1 - 5]");
		switch(strval(tmp))
		{
	...
	{
		if(!strlen(tmp)||strval(tmp)<1||strval(tmp)>7) return SendClientMessage(playerid,COLOR_INTERFACE,"{3494FF}Сервер: {FFFFFF}Используйте: /animbp [1 - 7]");
		switch(strval(tmp))
		{
	...
	{
		if(!strlen(tmp)||strval(tmp)<1||strval(tmp)>4) return SendClientMessage(playerid,COLOR_INTERFACE,"{3494FF}Сервер: {FFFFFF}Используйте: /animbf [1 - 4]");
		switch(strval(tmp))
		{
	...
	{
		if(!strlen(tmp)||strval(tmp)<1||strval(tmp)>19) return SendClientMessage(playerid,COLOR_INTERFACE,"{3494FF}Сервер: {FFFFFF}Используйте: /animbiked [1 - 19]");
		switch(strval(tmp))
		{
	...
	{
		if(!strlen(tmp)||strval(tmp)<1||strval(tmp)>18) return SendClientMessage(playerid,COLOR_INTERFACE,"{3494FF}Сервер: {FFFFFF}Используйте: /animbikeh [1 - 18]");
		switch(strval(tmp))
		{
	...
	{
		if(!strlen(tmp)||strval(tmp)<1||strval(tmp)>9) return SendClientMessage(playerid,COLOR_INTERFACE,"{3494FF}Сервер: {FFFFFF}Используйте: /animbikelp [1 - 9]");
		switch(strval(tmp))
		{
	...
	{
		if(!strlen(tmp)||strval(tmp)<1||strval(tmp)>20) return SendClientMessage(playerid,COLOR_INTERFACE,"{3494FF}Сервер: {FFFFFF}Используйте: /animbikes [1 - 20]");
		switch(strval(tmp))
		{
	...
	{
		if(!strlen(tmp)||strval(tmp)<1||strval(tmp)>18) return SendClientMessage(playerid,COLOR_INTERFACE,"{3494FF}Сервер: {FFFFFF}Используйте: /animbikev [1 - 18]");
		switch(strval(tmp))
		{
	...
	{
		if(!strlen(tmp)||strval(tmp)<1||strval(tmp)>4) return SendClientMessage(playerid,COLOR_INTERFACE,"{3494FF}Сервер: {FFFFFF}Используйте: /animbikedbz [1 - 4]");
		switch(strval(tmp))
		{
	...
	{
		if(!strlen(tmp)||strval(tmp)<1||strval(tmp)>18) return SendClientMessage(playerid,COLOR_INTERFACE,"{3494FF}Сервер: {FFFFFF}Используйте: /animbmx [1 - 18]");
		switch(strval(tmp))
		{
	...
	{
		if(!strlen(tmp)||strval(tmp)<1||strval(tmp)>6) return SendClientMessage(playerid,COLOR_INTERFACE,"{3494FF}Сервер: {FFFFFF}Используйте: /animbomber [1 - 6]");
		switch(strval(tmp))
		{
	...
	{
		if(!strlen(tmp)||strval(tmp)<1||strval(tmp)>10) return SendClientMessage(playerid,COLOR_INTERFACE,"{3494FF}Сервер: {FFFFFF}Используйте: /animbox [1 - 10]");
		switch(strval(tmp))
		{
	...
	{
		if(!strlen(tmp)||strval(tmp)<1||strval(tmp)>41) return SendClientMessage(playerid,COLOR_INTERFACE,"{3494FF}Сервер: {FFFFFF}Используйте: /animbasket [1 - 41]");
		switch(strval(tmp))
		{
	...
	{
		if(!strlen(tmp)||strval(tmp)<1||strval(tmp)>5) return SendClientMessage(playerid,COLOR_INTERFACE,"{3494FF}Сервер: {FFFFFF}Используйте: /animbuddy [1 - 5]");
		switch(strval(tmp))
		{
	...
	{
		if(!strlen(tmp)||strval(tmp)<1||strval(tmp)>9) return SendClientMessage(playerid,COLOR_INTERFACE,"{3494FF}Сервер: {FFFFFF}Используйте: /animbus [1 - 9]");
		switch(strval(tmp))
		{
	...
	{
		if(!strlen(tmp)||strval(tmp)<1||strval(tmp)>14) return SendClientMessage(playerid,COLOR_INTERFACE,"{3494FF}Сервер: {FFFFFF}Используйте: /animcamera [1 - 14]");
		switch(strval(tmp))
		{
	...
	{
		if(!strlen(tmp)||strval(tmp)<1||strval(tmp)>11) return SendClientMessage(playerid,COLOR_INTERFACE,"{3494FF}Сервер: {FFFFFF}Используйте: /animcar [1 - 11]");
		switch(strval(tmp))
		{
	...
	{
		if(!strlen(tmp)||strval(tmp)<1||strval(tmp)>7) return SendClientMessage(playerid,COLOR_INTERFACE,"{3494FF}Сервер: {FFFFFF}Используйте: /animcarry [1 - 7]");
		switch(strval(tmp))
		{
	...
	{
		if(!strlen(tmp)||strval(tmp)<1||strval(tmp)>21) return SendClientMessage(playerid,COLOR_INTERFACE,"{3494FF}Сервер: {FFFFFF}Используйте: /animcarchat [1 - 21]");
		switch(strval(tmp))
		{
	...
	{
		if(!strlen(tmp)||strval(tmp)<1||strval(tmp)>25) return SendClientMessage(playerid,COLOR_INTERFACE,"{3494FF}Сервер: {FFFFFF}Используйте: /animcasino [1 - 25]");
		switch(strval(tmp))
		{
	...
	{
		if(!strlen(tmp)||strval(tmp)<1||strval(tmp)>11) return SendClientMessage(playerid,COLOR_INTERFACE,"{3494FF}Сервер: {FFFFFF}Используйте: /animsaw [1 - 11]");
		switch(strval(tmp))
		{
	...
	{
		if(!strlen(tmp)||strval(tmp)<1||strval(tmp)>18) return SendClientMessage(playerid,COLOR_INTERFACE,"{3494FF}Сервер: {FFFFFF}Используйте: /animchoppa [1 - 18]");
		switch(strval(tmp))
		{
	...
	{
		if(!strlen(tmp)||strval(tmp)<1||strval(tmp)>13) return SendClientMessage(playerid,COLOR_INTERFACE,"{3494FF}Сервер: {FFFFFF}Используйте: /animclothes [1 - 13]");
		switch(strval(tmp))
		{
	...
	{
		if(!strlen(tmp)||strval(tmp)<1||strval(tmp)>6) return SendClientMessage(playerid,COLOR_INTERFACE,"{3494FF}Сервер: {FFFFFF}Используйте: /animcoach [1 - 6]");
		switch(strval(tmp))
		{
	...
	{
		if(!strlen(tmp)||strval(tmp)<1||strval(tmp)>7) return SendClientMessage(playerid,COLOR_INTERFACE,"{3494FF}Сервер: {FFFFFF}Используйте: /animcolt [1 - 7]");
		switch(strval(tmp))
		{
	...
	{
		if(!strlen(tmp)||strval(tmp)<1||strval(tmp)>12) return SendClientMessage(playerid,COLOR_INTERFACE,"{3494FF}Сервер: {FFFFFF}Используйте: /animcopa [1 - 12]");
		switch(strval(tmp))
		{
	...
	{
		if(!strlen(tmp)||strval(tmp)<1||strval(tmp)>4) return SendClientMessage(playerid,COLOR_INTERFACE,"{3494FF}Сервер: {FFFFFF}Используйте: /animcopdvb [1 - 4]");
		switch(strval(tmp))
		{
	...
	{
		if(!strlen(tmp)||strval(tmp)<1||strval(tmp)>10) return SendClientMessage(playerid,COLOR_INTERFACE,"{3494FF}Сервер: {FFFFFF}Используйте: /animcrack[1 - 10]");
		switch(strval(tmp))
		{
	...
	{
		if(!strlen(tmp)||strval(tmp)<1||strval(tmp)>5) return SendClientMessage(playerid,COLOR_INTERFACE,"{3494FF}Сервер: {FFFFFF}Используйте: /animcrib [1 - 5]");
		switch(strval(tmp))
		{
	...
	{
		if(!strlen(tmp)||strval(tmp)<1||strval(tmp)>5)return SendClientMessage(playerid,COLOR_INTERFACE,"{3494FF}Сервер: {FFFFFF}Используйте: /animdamjump [1 - 5]");
		switch(strval(tmp))
		{
	...
	{
		if(!strlen(tmp)||strval(tmp)<1||strval(tmp)>13) return SendClientMessage(playerid,COLOR_INTERFACE,"{3494FF}Сервер: {FFFFFF}Используйте: /animdance [1 - 13]");
		switch(strval(tmp))
		{
	...
	{
		if(!strlen(tmp)||strval(tmp)<1||strval(tmp)>7) return SendClientMessage(playerid,COLOR_INTERFACE,"{3494FF}Сервер: {FFFFFF}Используйте: /animdealer [1 - 7]");
		switch(strval(tmp))
		{
	...
	{
		if(!strlen(tmp)||strval(tmp)<1||strval(tmp)>9) return SendClientMessage(playerid,COLOR_INTERFACE,"{3494FF}Сервер: {FFFFFF}Используйте: /animdildo [1 - 9]");
		switch(strval(tmp))
		{
	...
	{
		if(!strlen(tmp)||strval(tmp)<1||strval(tmp)>4) return SendClientMessage(playerid,COLOR_INTERFACE,"{3494FF}Сервер: {FFFFFF}Используйте: /animdodge [1 - 4]");
		switch(strval(tmp))
		{
	...
	{
		if(!strlen(tmp)||strval(tmp)<1||strval(tmp)>10) return SendClientMessage(playerid,COLOR_INTERFACE,"{3494FF}Сервер: {FFFFFF}Используйте: /animdozer [1 - 10]");
		switch(strval(tmp))
		{
	...
	{
		if(!strlen(tmp)||strval(tmp)<1||strval(tmp)>8) return SendClientMessage(playerid,COLOR_INTERFACE,"{3494FF}Сервер: {FFFFFF}Используйте: /animdrivebys [1 - 8]");
		switch(strval(tmp))
		{
	...
	{
		if(!strlen(tmp)||strval(tmp)<1||strval(tmp)>18) return SendClientMessage(playerid,COLOR_INTERFACE,"{3494FF}Сервер: {FFFFFF}Используйте: /animfat [1 - 18]");
		switch(strval(tmp))
		{
	...
	{
		if(!strlen(tmp)||strval(tmp)<1||strval(tmp)>10) return SendClientMessage(playerid,COLOR_INTERFACE,"{3494FF}Сервер: {FFFFFF}Используйте: /animfightb [1 - 10]");
		switch(strval(tmp))
		{
	...
	{
		if(!strlen(tmp)||strval(tmp)<1||strval(tmp)>12) return SendClientMessage(playerid,COLOR_INTERFACE,"{3494FF}Сервер: {FFFFFF}Используйте: /animfightc [1 - 12]");
		switch(strval(tmp))
		{
	...
	{
		if(!strlen(tmp)||strval(tmp)<1||strval(tmp)>10) return SendClientMessage(playerid,COLOR_INTERFACE,"{3494FF}Сервер: {FFFFFF}Используйте: /animfightd [1 - 10]");
		switch(strval(tmp))
		{
	...
	{
		if(!strlen(tmp)||strval(tmp)<1||strval(tmp)>4) return SendClientMessage(playerid,COLOR_INTERFACE,"{3494FF}Сервер: {FFFFFF}Используйте: /animfighte [1 - 4]");
		switch(strval(tmp))
		{
	...
	{
		if(!strlen(tmp)||strval(tmp)<1||strval(tmp)>16) return SendClientMessage(playerid,COLOR_INTERFACE,"{3494FF}Сервер: {FFFFFF}Используйте: /animfinale [1 - 16]");
		switch(strval(tmp))
		{
	...
	{
		if(!strlen(tmp)||strval(tmp)<1||strval(tmp)>8) return SendClientMessage(playerid,COLOR_INTERFACE,"{3494FF}Сервер: {FFFFFF}Используйте: /animfinale2 [1 - 8]");
		switch(strval(tmp))
		{
	...
	{
		if(!strlen(tmp)||strval(tmp)<1||strval(tmp)>3) return SendClientMessage(playerid,COLOR_INTERFACE,"{3494FF}Сервер: {FFFFFF}Используйте: /animflowers [1 - 3]");
		switch(strval(tmp))
		{
	...
	{
		if(!strlen(tmp)||strval(tmp)<1||strval(tmp)>33)return SendClientMessage(playerid,COLOR_INTERFACE,"{3494FF}Сервер: {FFFFFF}Используйте: /animfood [1 - 33]");
		switch(strval(tmp))
		{
	...
	{
		if(!strlen(tmp)||strval(tmp)<1||strval(tmp)>9) return SendClientMessage(playerid,COLOR_INTERFACE,"{3494FF}Сервер: {FFFFFF}Используйте: /animfw [1 - 9]");
		switch(strval(tmp))
		{
	...
	{
		if(!strlen(tmp)||strval(tmp)<1||strval(tmp)>33) return SendClientMessage(playerid,COLOR_INTERFACE,"{3494FF}Сервер: {FFFFFF}Используйте: /animgangs [1 - 33]");
		switch(strval(tmp))
		{
	...
	{
		if(!strlen(tmp)||strval(tmp)<1||strval(tmp)>20) return SendClientMessage(playerid,COLOR_INTERFACE,"{3494FF}Сервер: {FFFFFF}Используйте: /animghands [1 - 20]");
		switch(strval(tmp))
		{
	...
	{
		if(!strlen(tmp)||strval(tmp)<1||strval(tmp)>7) return SendClientMessage(playerid,COLOR_INTERFACE,"{3494FF}Сервер: {FFFFFF}Используйте: /animghettodb [1 - 7]");
		switch(strval(tmp))
		{
	...
	{
		if(!strlen(tmp)||strval(tmp)<1||strval(tmp)>2) return SendClientMessage(playerid,COLOR_INTERFACE,"{3494FF}Сервер: {FFFFFF}Используйте: /animgraffity [1 - 2]");
		switch(strval(tmp))
		{
	...
	{
		if(!strlen(tmp)||strval(tmp)<1||strval(tmp)>3) return SendClientMessage(playerid,COLOR_INTERFACE,"{3494FF}Сервер: {FFFFFF}Используйте: /animgreya [1 - 3]");
		switch(strval(tmp))
		{
	...
	{
		if(!strlen(tmp)||strval(tmp)<1||strval(tmp)>3) return SendClientMessage(playerid,COLOR_INTERFACE,"{3494FF}Сервер: {FFFFFF}Используйте: /animgren [1 - 3]");
		switch(strval(tmp))
		{
	...
	{
		if(!strlen(tmp)||strval(tmp)<1||strval(tmp)>24) return SendClientMessage(playerid,COLOR_INTERFACE,"{3494FF}Сервер: {FFFFFF}Используйте: /animgym [1 - 24]");
		switch(strval(tmp))
		{
	...
	{
		if(!strlen(tmp)||strval(tmp)<1||strval(tmp)>13) return SendClientMessage(playerid,COLOR_INTERFACE,"{3494FF}Сервер: {FFFFFF}Используйте: /animhaircut [1 - 13]");
		switch(strval(tmp))
		{
	...
	{
		if(!strlen(tmp)||strval(tmp)<1||strval(tmp)>10) return SendClientMessage(playerid,COLOR_INTERFACE,"{3494FF}Сервер: {FFFFFF}Используйте: /animheist [1 - 10]");
		switch(strval(tmp))
		{
	...
	{
		if(!strlen(tmp)||strval(tmp)<1||strval(tmp)>10) return SendClientMessage(playerid,COLOR_INTERFACE,"{3494FF}Сервер: {FFFFFF}Используйте: /animinthouse [1 - 10]");
		switch(strval(tmp))
		{
	...
	{
		if(!strlen(tmp)||strval(tmp)<1||strval(tmp)>10) return SendClientMessage(playerid,COLOR_INTERFACE,"{3494FF}Сервер: {FFFFFF}Используйте: /animintoffice [1 - 10]");
		switch(strval(tmp))
		{
	...
	{
		if(!strlen(tmp)||strval(tmp)<1||strval(tmp)>8) return SendClientMessage(playerid,COLOR_INTERFACE,"{3494FF}Сервер: {FFFFFF}Используйте: /animintshop [1 - 8]");
		switch(strval(tmp))
		{
	...
	{
		if(!strlen(tmp)||strval(tmp)<1||strval(tmp)>4) return SendClientMessage(playerid,COLOR_INTERFACE,"{3494FF}Сервер: {FFFFFF}Используйте: /animjst [1 - 4]");
		switch(strval(tmp))
		{
	...
	{
		if(!strlen(tmp)||strval(tmp)<1||strval(tmp)>4) return SendClientMessage(playerid,COLOR_INTERFACE,"{3494FF}Сервер: {FFFFFF}Используйте: /animkart [1 - 4]");
		switch(strval(tmp))
		{
	...
	{
		if(!strlen(tmp)||strval(tmp)<1||strval(tmp)>15) return SendClientMessage(playerid,COLOR_INTERFACE,"{3494FF}Сервер: {FFFFFF}Используйте: /animkissing [1 - 15]");
		switch(strval(tmp))
		{
	...
	{
		if(!strlen(tmp)||strval(tmp)<1||strval(tmp)>16) return SendClientMessage(playerid,COLOR_INTERFACE,"{3494FF}Сервер: {FFFFFF}Используйте: /animknife [1 - 16]");
		switch(strval(tmp))
		{
	...
	{
		if(!strlen(tmp)||strval(tmp)<1||strval(tmp)>2) return SendClientMessage(playerid,COLOR_INTERFACE,"{3494FF}Сервер: {FFFFFF}Используйте: /animlapdan1 [1 - 2]");
		switch(strval(tmp))
		{
	...
	{
		if(!strlen(tmp)||strval(tmp)<1||strval(tmp)>2) return SendClientMessage(playerid,COLOR_INTERFACE,"{3494FF}Сервер: {FFFFFF}Используйте: /animlapdan2 [1 - 2]");
		switch(strval(tmp))
		{
	...
	{
		if(!strlen(tmp)||strval(tmp)<1||strval(tmp)>2) return SendClientMessage(playerid,COLOR_INTERFACE,"{3494FF}Сервер: {FFFFFF}Используйте: /animlapdan3 [1 - 2]");
		switch(strval(tmp))
		{
	...
	{
		if(!strlen(tmp)||strval(tmp)<1||strval(tmp)>39) return SendClientMessage(playerid,COLOR_INTERFACE,"{3494FF}Сервер: {FFFFFF}Используйте: /animlowrider [1 - 39]");
		switch(strval(tmp))
		{
	...
	{
		if(!strlen(tmp)||strval(tmp)<1||strval(tmp)>25) return SendClientMessage(playerid,COLOR_INTERFACE,"{3494FF}Сервер: {FFFFFF}Используйте: /animmdchase [1 - 25]");
		switch(strval(tmp))
		{
	...
	{
		if(!strlen(tmp)||strval(tmp)<1||strval(tmp)>8) return SendClientMessage(playerid,COLOR_INTERFACE,"{3494FF}Сервер: {FFFFFF}Используйте: /animmddend [1 - 8]");
		switch(strval(tmp))
		{
	...
	{
		if(!strlen(tmp)||strval(tmp)<1||strval(tmp)>41) return SendClientMessage(playerid,COLOR_INTERFACE,"{3494FF}Сервер: {FFFFFF}Используйте: /animms [1 - 41]");
		switch(strval(tmp))
		{
	...
	{
		if(!strlen(tmp)||strval(tmp)<1||strval(tmp)>18) return SendClientMessage(playerid,COLOR_INTERFACE,"{3494FF}Сервер: {FFFFFF}Используйте: /animmtb [1 - 18]");
		switch(strval(tmp))
		{
	...
	{
		if(!strlen(tmp)||strval(tmp)<1||strval(tmp)>17) return SendClientMessage(playerid,COLOR_INTERFACE,"{3494FF}Сервер: {FFFFFF}Используйте: /animmusculcar [1 - 17]");
		switch(strval(tmp))
		{
	...
	{
		if(!strlen(tmp)||strval(tmp)<1||strval(tmp)>2) return SendClientMessage(playerid,COLOR_INTERFACE,"{3494FF}Сервер: {FFFFFF}Используйте: /animnevada [1 - 2]");
		switch(strval(tmp))
		{
	...
	{
		if(!strlen(tmp)||strval(tmp)<1||strval(tmp)>29) return SendClientMessage(playerid,COLOR_INTERFACE,"{3494FF}Сервер: {FFFFFF}Используйте: /animlookers [1 - 29]");
		switch(strval(tmp))
		{
	...
	{
		if(!strlen(tmp)||strval(tmp)<1||strval(tmp)>11) return SendClientMessage(playerid,COLOR_INTERFACE,"{3494FF}Сервер: {FFFFFF}Используйте: /animotb [1 - 11]");
		switch(strval(tmp))
		{
	...
	{
		if(!strlen(tmp)||strval(tmp)<1||strval(tmp)>22) return SendClientMessage(playerid,COLOR_INTERFACE,"{3494FF}Сервер: {FFFFFF}Используйте: /animpara [1 - 22]");
		switch(strval(tmp))
		{
	...
	{
		if(!strlen(tmp)||strval(tmp)<1||strval(tmp)>3) return SendClientMessage(playerid,COLOR_INTERFACE,"{3494FF}Сервер: {FFFFFF}Используйте: /animpark [1 - 3]");
		switch(strval(tmp))
		{
	...
	{
		if(!strlen(tmp)||strval(tmp)<1||strval(tmp)>12) return SendClientMessage(playerid,COLOR_INTERFACE,"{3494FF}Сервер: {FFFFFF}Используйте: /animpaulnmac [1 - 12]");
		switch(strval(tmp))
		{
	...
	{
		if(!strlen(tmp)||strval(tmp)<1||strval(tmp)>295) return SendClientMessage(playerid,COLOR_INTERFACE,"{3494FF}Сервер: {FFFFFF}Используйте: /animped [1 - 295]");
		switch(strval(tmp))
		{
	...
	{
		if(!strlen(tmp)||strval(tmp)<1||strval(tmp)>4) return SendClientMessage(playerid,COLOR_INTERFACE,"{3494FF}Сервер: {FFFFFF}Используйте: /animplayerdvbys [1 - 4]");
		switch(strval(tmp))
		{
	...
	{
		if(!strlen(tmp)||strval(tmp)<1||strval(tmp)>5) return SendClientMessage(playerid,COLOR_INTERFACE,"{3494FF}Сервер: {FFFFFF}Используйте: /animplayidles [1 - 5]");
		switch(strval(tmp))
		{
	...
	{
		if(!strlen(tmp)||strval(tmp)<1||strval(tmp)>10) return SendClientMessage(playerid,COLOR_INTERFACE,"{3494FF}Сервер: {FFFFFF}Используйте: /animpolice [1 - 10]");
		switch(strval(tmp))
		{
	...
	{
		if(!strlen(tmp)||strval(tmp)<1||strval(tmp)>21) return SendClientMessage(playerid,COLOR_INTERFACE,"{3494FF}Сервер: {FFFFFF}Используйте: /animpool [1 - 21]");
		switch(strval(tmp))
		{
	...
	{
		if(!strlen(tmp)||strval(tmp)<1||strval(tmp)>2) return SendClientMessage(playerid,COLOR_INTERFACE,"{3494FF}Сервер: {FFFFFF}Используйте: /animpoor [1 - 2]");
		switch(strval(tmp))
		{
	...
	{
		if(!strlen(tmp)||strval(tmp)<1||strval(tmp)>5) return SendClientMessage(playerid,COLOR_INTERFACE,"{3494FF}Сервер: {FFFFFF}Используйте: /animpython [1 - 5]");
		switch(strval(tmp))
		{
	...
	{
		if(!strlen(tmp)||strval(tmp)<1||strval(tmp)>17) return SendClientMessage(playerid,COLOR_INTERFACE,"{3494FF}Сервер: {FFFFFF}Используйте: /animquad [1 - 17]");
		switch(strval(tmp))
		{
	...
	{
		if(!strlen(tmp)||strval(tmp)<1||strval(tmp)>4) return SendClientMessage(playerid,COLOR_INTERFACE,"{3494FF}Сервер: {FFFFFF}Используйте: /animquadbz [1 - 4]");
		switch(strval(tmp))
		{
	...
	{
		if(!strlen(tmp)||strval(tmp)<1||strval(tmp)>8) return SendClientMessage(playerid,COLOR_INTERFACE,"{3494FF}Сервер: {FFFFFF}Используйте: /animrapping [1 - 8]");
		switch(strval(tmp))
		{
	...
	{
		if(!strlen(tmp)||strval(tmp)<1||strval(tmp)>5) return SendClientMessage(playerid,COLOR_INTERFACE,"{3494FF}Сервер: {FFFFFF}Используйте: /animrifle [1 - 5]");
		switch(strval(tmp))
		{
	...
	{
		if(!strlen(tmp)||strval(tmp)<1||strval(tmp)>7) return SendClientMessage(playerid,COLOR_INTERFACE,"{3494FF}Сервер: {FFFFFF}Используйте: /animriot [1 - 7]");
		switch(strval(tmp))
		{
	...
	{
		if(!strlen(tmp)||strval(tmp)<1||strval(tmp)>5) return SendClientMessage(playerid,COLOR_INTERFACE,"{3494FF}Сервер: {FFFFFF}Используйте: /animrobbank [1 - 5]");
		switch(strval(tmp))
		{
	...
	{
		if(!strlen(tmp)||strval(tmp)<1||strval(tmp)>5) return SendClientMessage(playerid,COLOR_INTERFACE,"{3494FF}Сервер: {FFFFFF}Используйте: /animrocket [1 - 5]");
		switch(strval(tmp))
		{
	...
	{
		if(!strlen(tmp)||strval(tmp)<1||strval(tmp)>5) return SendClientMessage(playerid,COLOR_INTERFACE,"{3494FF}Сервер: {FFFFFF}Используйте: /animrustler [1 - 5]");
		switch(strval(tmp))
		{
	...
	{
		if(!strlen(tmp)||strval(tmp)<1||strval(tmp)>16) return SendClientMessage(playerid,COLOR_INTERFACE,"{3494FF}Сервер: {FFFFFF}Используйте: /animryder [1 - 16]");
		switch(strval(tmp))
		{
	...
	{
		if(!strlen(tmp)||strval(tmp)<1||strval(tmp)>12) return SendClientMessage(playerid,COLOR_INTERFACE,"{3494FF}Сервер: {FFFFFF}Используйте: /animscratching [1 - 12]");
		switch(strval(tmp))
		{
	...
	{
		if(!strlen(tmp)||strval(tmp)<1||strval(tmp)>4) return SendClientMessage(playerid,COLOR_INTERFACE,"{3494FF}Сервер: {FFFFFF}Используйте: /animshamal [1 - 4]");
		switch(strval(tmp))
		{
	...
	{
		if(!strlen(tmp)||strval(tmp)<1||strval(tmp)>25) return SendClientMessage(playerid,COLOR_INTERFACE,"{3494FF}Сервер: {FFFFFF}Используйте: /animshop [1 - 25]");
		switch(strval(tmp))
		{
	...
	{
		if(!strlen(tmp)||strval(tmp)<1||strval(tmp)>3) return SendClientMessage(playerid,COLOR_INTERFACE,"{3494FF}Сервер: {FFFFFF}Используйте: /animshotgun [1 - 3]");
		switch(strval(tmp))
		{
	...
	{
		if(!strlen(tmp)||strval(tmp)<1||strval(tmp)>4) return SendClientMessage(playerid,COLOR_INTERFACE,"{3494FF}Сервер: {FFFFFF}Используйте: /animsilenced [1 - 4]");
		switch(strval(tmp))
		{
	...
	{
		if(!strlen(tmp)||strval(tmp)<1||strval(tmp)>3) return SendClientMessage(playerid,COLOR_INTERFACE,"{3494FF}Сервер: {FFFFFF}Используйте: /animskate [1 - 3]");
		switch(strval(tmp))
		{
	...
	{
		if(!strlen(tmp)||strval(tmp)<1||strval(tmp)>8) return SendClientMessage(playerid,COLOR_INTERFACE,"{3494FF}Сервер: {FFFFFF}Используйте: /animsmoking [1 - 8]");
		switch(strval(tmp))
		{
	...
	{
		if(!strlen(tmp)||strval(tmp)<1||strval(tmp)>2) return SendClientMessage(playerid,COLOR_INTERFACE,"{3494FF}Сервер: {FFFFFF}Используйте: /animspraycan [1 - 2]");
		switch(strval(tmp))
		{
	...
	{
		if(!strlen(tmp)||strval(tmp)<1||strval(tmp)>20) return SendClientMessage(playerid,COLOR_INTERFACE,"{3494FF}Сервер: {FFFFFF}Используйте: /animstrip [1 - 20]");
		switch(strval(tmp))
		{
	...
	{
		if(!strlen(tmp)||strval(tmp)<1||strval(tmp)>18) return SendClientMessage(playerid,COLOR_INTERFACE,"{3494FF}Сервер: {FFFFFF}Используйте: /animbath [1 - 18]");
		switch(strval(tmp))
		{
	...
	{
		if(!strlen(tmp)||strval(tmp)<1||strval(tmp)>23) return SendClientMessage(playerid,COLOR_INTERFACE,"{3494FF}Сервер: {FFFFFF}Используйте: /animswat [1 - 23]");
		switch(strval(tmp))
		{
	...
	{
		if(!strlen(tmp)||strval(tmp)<1||strval(tmp)>7) return SendClientMessage(playerid,COLOR_INTERFACE,"{3494FF}Сервер: {FFFFFF}Используйте: /animsweet [1 - 7]");
		switch(strval(tmp))
		{
	...
	{
		if(!strlen(tmp)||strval(tmp)<1||strval(tmp)>7) return SendClientMessage(playerid,COLOR_INTERFACE,"{3494FF}Сервер: {FFFFFF}Используйте: /animswim [1 - 7]");
		switch(strval(tmp))
		{
	...
	{
		if(!strlen(tmp)||strval(tmp)<1||strval(tmp)>10) return SendClientMessage(playerid,COLOR_INTERFACE,"{3494FF}Сервер: {FFFFFF}Используйте: /animsword [1 - 10]");
		switch(strval(tmp))
		{
	...
	{
		if(!strlen(tmp)||strval(tmp)<1||strval(tmp)>6) return SendClientMessage(playerid,COLOR_INTERFACE,"{3494FF}Сервер: {FFFFFF}Используйте: /animtank [1 - 6]");
		switch(strval(tmp))
		{
	...
	{
		if(!strlen(tmp)||strval(tmp)<1||strval(tmp)>57) return SendClientMessage(playerid,COLOR_INTERFACE,"{3494FF}Сервер: {FFFFFF}Используйте: /animtattoos [1 - 57]");
		switch(strval(tmp))
		{
	...
	{
		if(!strlen(tmp)||strval(tmp)<1||strval(tmp)>4) return SendClientMessage(playerid,COLOR_INTERFACE,"{3494FF}Сервер: {FFFFFF}Используйте: /animtec [1 - 4]");
		switch(strval(tmp))
		{
	...
	{
		if(!strlen(tmp)||strval(tmp)<1||strval(tmp)>4) return SendClientMessage(playerid,COLOR_INTERFACE,"{3494FF}Сервер: {FFFFFF}Используйте: /animtrain [1 - 4]");
		switch(strval(tmp))
		{
	...
	{
		if(!strlen(tmp)||strval(tmp)<1||strval(tmp)>17) return SendClientMessage(playerid,COLOR_INTERFACE,"{3494FF}Сервер: {FFFFFF}Используйте: /animtruck [1 - 17]");
		switch(strval(tmp))
		{
	...
	{
		if(!strlen(tmp)||strval(tmp)<1||strval(tmp)>5) return SendClientMessage(playerid,COLOR_INTERFACE,"{3494FF}Сервер: {FFFFFF}Используйте: /animuzi [1 - 5]");
		switch(strval(tmp))
		{
	...
	{
		if(!strlen(tmp)||strval(tmp)<1||strval(tmp)>8) return SendClientMessage(playerid,COLOR_INTERFACE,"{3494FF}Сервер: {FFFFFF}Используйте: /animvan [1 - 8]");
		switch(strval(tmp))
		{
	...
	{
		if(!strlen(tmp)||strval(tmp)<1||strval(tmp)>6) return SendClientMessage(playerid,COLOR_INTERFACE,"{3494FF}Сервер: {FFFFFF}Используйте: /animvending [1 - 6]");
		switch(strval(tmp))
		{
	...
	{
		if(!strlen(tmp)||strval(tmp)<1||strval(tmp)>4) return SendClientMessage(playerid,COLOR_INTERFACE,"{3494FF}Сервер: {FFFFFF}Используйте: /animvortex [1 - 4]");
		switch(strval(tmp))
		{
	...
	{
		if(!strlen(tmp)||strval(tmp)<1||strval(tmp)>18) return SendClientMessage(playerid,COLOR_INTERFACE,"{3494FF}Сервер: {FFFFFF}Используйте: /animway [1 - 18]");
		switch(strval(tmp))
		{
	...
	{
		if(!strlen(tmp)||strval(tmp)<1||strval(tmp)>17) return SendClientMessage(playerid,COLOR_INTERFACE,"{3494FF}Сервер: {FFFFFF}Используйте: /animweap [1 - 17]");
		switch(strval(tmp))
		{
	...
	{
		if(!strlen(tmp)||strval(tmp)<1||strval(tmp)>12) return SendClientMessage(playerid,COLOR_INTERFACE,"{3494FF}Сервер: {FFFFFF}Используйте: /animwuzi [1 - 12]");
		switch(strval(tmp))
		{
	...
	{
		if(!strlen(tmp)||strval(tmp)<1||strval(tmp)>8) return SendClientMessage(playerid,COLOR_INTERFACE,"{3494FF}Сервер: {FFFFFF}Используйте: /animsnm [1 - 8]");
		switch(strval(tmp))
		{
	...
	{
		if(!strlen(tmp)||strval(tmp)<1||strval(tmp)>12) return SendClientMessage(playerid,COLOR_INTERFACE,"{3494FF}Сервер: {FFFFFF}Используйте: /animblowjob [1 - 12]");
		switch(strval(tmp))
		{
	...
	{
	    SendClientMessage(playerid,COLOR_INTERFACE,"Список доступных специальных действий:");

		SendClientMessage(playerid,COLOR_INTERFACE,"/exitveh - выход из транспорта (срабатывает, если игрок находится в транспорте).");
        SendClientMessage(playerid,COLOR_INTERFACE,"/dance [1 - 4] - танцы различных стилей (1 - робкий, 2 - хип-хоп, 3 - буги, 4 - стриптиз).");
        SendClientMessage(playerid,COLOR_INTERFACE,"/handsup - поднять руки вверх.");
        SendClientMessage(playerid,COLOR_INTERFACE,"/cellin - взять телефон.");
        SendClientMessage(playerid,COLOR_INTERFACE,"/cellout - положить телефон.");
        SendClientMessage(playerid,COLOR_INTERFACE,"/beer - взять бутылку пива (при выпивании (клавиша \"выстрел\") повышается уровень опьянения).");
        SendClientMessage(playerid,COLOR_INTERFACE,"/smoke - курить сигару.");
        SendClientMessage(playerid,COLOR_INTERFACE,"/wine - взять бутылку вина (при выпивании (клавиша \"выстрел\") повышается уровень опьянения).");
        SendClientMessage(playerid,COLOR_INTERFACE,"/sprunk - взять алюминиевую банку напитка \"Sprunk\".");
        SendClientMessage(playerid,COLOR_INTERFACE,"/pee - справить малую нужду.");
        SendClientMessage(playerid,COLOR_INTERFACE,"/stopspac - остановить анимацию (или используйте клавишу \"сесть в транспорт\").");
		return 1;
	}
	...
	{
	    if(!strlen(tmp)||strval(tmp)<1||strval(tmp)>4) return SendClientMessage(playerid,COLOR_INTERFACE,"Неверный ID специального действия. Диапазон стилей танца: от 1 до 4.");
	    switch(strval(tmp))
	    {
